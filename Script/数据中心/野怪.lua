...
-- @Last Modified time: 2024-11-10 20:31:18
...
function 取敌人信息(dr)
	...
	elseif dr == 130006 then
		drs = {"般若天女","般若天女",175,2,1420,1600,5500,2500,1610,1500,0,nil,nil,{"上古灵符","高级飞行","敏捷","魔之心","高级慧根"},nil,true,20281}
	elseif dr == 130007 then
		drs = {"般若天女头领","般若天女",175,2.2,1420,1600,5500,2500,1610,1500,1,nil,nil,{"上古灵符","高级飞行","敏捷","魔之心","高级慧根"},nil,true,20281}
	elseif dr == 130008 then
		drs = {"般若天女宝宝","般若天女",1,2,1420,1600,5500,2500,1610,1500,2,nil,nil,{"上古灵符","高级飞行","敏捷","魔之心","高级慧根"},nil,true,0}
	...
	elseif dr == -9983 then
		drs = {"藤蔓妖花","藤蔓妖花",155,2,1464,1440,4560,3120,1200,1440,0,nil,nil,{"灵能激发","落岩","高级招架","高级法术连击"},nil,nil,14281}
	elseif dr == -9982 then
		drs = {"藤蔓妖花头领","藤蔓妖花",155,2.2,1464,1440,4560,3120,1200,1440,1,nil,nil,{"灵能激发","落岩","高级招架","高级法术连击"},nil,nil,14581}
	elseif dr == -9981 then
		drs = {"藤蔓妖花宝宝","藤蔓妖花",0,1,0,0,0,0,0,0,2,nil,nil,{"灵能激发","落岩","高级招架","高级法术连击"},nil,nil,0}
	elseif dr == -9980 then
		drs = {"变异藤蔓妖花","藤蔓妖花",0,1,0,0,0,0,0,0,3,2042,{1,0},{"灵能激发","落岩","高级招架","高级法术连击"},nil,nil,0}
    ...
    elseif dr == 31002 then
		drs = {"白豹","白豹",155,2,1536,1440,4800,2280,1440,1560,0,nil,nil,{"驱鬼","高级飞行","高级强力","偷袭","吸血"},nil,nil,14281}
	elseif dr == 31003 then
		drs = {"白豹宝宝","白豹",0,1,0,0,0,0,0,0,2,nil,nil,{"驱鬼","高级飞行","高级强力","偷袭","吸血"},nil,nil,0}
...
-- 75级
    ...
    elseif dr == -29551 then
		drs = {"龙鲤","龙鲤",65,2.6,1300,1300,5000,2800,1300,1500,0,nil,nil,{"高级幸运","必杀","风起龙游","法术连击","高级连击"},nil,nil,85650}
	elseif dr == -29541 then
		drs = {"龙鲤头领","龙鲤",65,2.7,1300,1300,5000,2800,1300,1500,1,nil,nil,{"高级幸运","必杀","风起龙游","法术连击","高级连击"},nil,nil,90120}
	elseif dr == -29531 then
		drs = {"龙鲤宝宝","龙鲤",0,1,0,0,0,0,0,0,2,nil,nil,{"高级幸运","必杀","风起龙游","法术连击","高级连击"},nil,nil,0}
	elseif dr == -29521 then
		drs = {"变异龙鲤","龙鲤",0,1,0,0,0,0,0,0,3,90,{1,1},{"高级幸运","必杀","风起龙游","法术连击","高级连击"},nil,nil,0}

    elseif dr == 30042 then
		drs = {"妙华天女","妙华天女",175,2.6,1300,1300,5000,2800,1300,1500,0,nil,nil,{"凝光炼彩","高级永恒","冥思","再生"},nil,nil,85650}
	elseif dr == 30043 then
		drs = {"妙华天女头领","妙华天女",175,2.7,1300,1300,5000,2800,1300,1500,1,nil,nil,{"凝光炼彩","高级永恒","冥思","再生"},nil,nil,90120}
	elseif dr == 30044 then
		drs = {"妙华天女宝宝","妙华天女",0,1,0,0,0,0,0,0,2,nil,nil,{"凝光炼彩","高级永恒","冥思","再生"},nil,nil,0}
	elseif dr == 30045 then
		drs = {"变异妙华天女","妙华天女",0,1,0,0,0,0,0,0,3,90,{1,1},{"凝光炼彩","高级永恒","冥思","再生"},nil,nil,0}

    elseif dr == 31042 then
		drs = {"广目巡守","广目巡守",175,2.6,1300,1300,5000,2800,1300,1500,0,nil,nil,{"净台妙谛","高级敏捷","防御","神佑复生"},nil,nil,85650}
	elseif dr == 31043 then
		drs = {"广目巡守头领","广目巡守",175,2.7,1300,1300,5000,2800,1300,1500,1,nil,nil,{"净台妙谛","高级敏捷","防御","神佑复生"},nil,nil,90120}
	elseif dr == 31044 then
		drs = {"广目巡守宝宝","广目巡守",0,1,0,0,0,0,0,0,2,nil,nil,{"净台妙谛","高级敏捷","防御","神佑复生"},nil,nil,0}
	elseif dr == 31045 then
		drs = {"变异广目巡守","广目巡守",0,1,0,0,0,0,0,0,3,90,{1,1},{"净台妙谛","高级敏捷","防御","神佑复生"},nil,nil,0}

    elseif dr == 31142 then
		drs = {"执音","执音",155,2.6,1300,1300,5000,2800,1300,1500,0,nil,nil,{"净台妙谛","高级敏捷","防御","神佑复生"},nil,nil,85650}
	elseif dr == 31143 then
		drs = {"执音头领","执音",155,2.7,1300,1300,5000,2800,1300,1500,1,nil,nil,{"净台妙谛","高级敏捷","防御","神佑复生"},nil,nil,90120}
	elseif dr == 31144 then
		drs = {"执音宝宝","执音",0,1,0,0,0,0,0,0,2,nil,nil,{"净台妙谛","高级敏捷","防御","神佑复生"},nil,nil,0}
	elseif dr == 31145 then
		drs = {"变异执音","执音",0,1,0,0,0,0,0,0,3,90,{1,1},{"净台妙谛","高级敏捷","防御","神佑复生"},nil,nil,0}
-- 55级
	elseif dr == -1496 then
...
--  5级
	...
	elseif dr == -496 then
		drs = {"狸","狸",6,2,1200,1200,3500,1400,900,900,0,nil,nil,{"感知","高级感知","高级幸运","强力","弱点土","弱点火"},nil,nil,3205}
	elseif dr == -495 then
		drs = {"狸头领","狸",7,2.2,1200,1200,3500,1400,900,900,1,nil,nil,{"感知","高级感知","高级幸运","强力","弱点土","弱点火"},nil,nil,3500}
	elseif dr == -494 then
		drs = {"狸宝宝","狸",0,1,0,0,0,0,0,0,2,nil,nil,{"感知","高级感知","高级幸运","强力","弱点土","弱点火"},nil,nil,0}
	elseif dr == -493 then
		drs = {"变异狸","狸",0,1,0,0,0,0,0,0,3,2079,{5},{"感知","高级感知","高级幸运","强力","弱点土","弱点火"},nil,nil,0}
	...
	-- 1名称，2模型，3等级，4成长，5攻击资质，6防御资质，7体力资质，8法力资质，9速度资质，10躲闪资质，11种类，12染色方案(可空),13染色ID(可空),14技能组，15是否开启必带技能，16武器逻辑,17经验,18默认分配潜能，19开启智能(不开启也就是进行傻逼般的行为),20门派，21技能等级(留空默认为人物等级)
	return drs
end