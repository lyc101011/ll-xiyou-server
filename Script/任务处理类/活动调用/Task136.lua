-- -- @作者: baidwwy
-- -- @邮箱:  313738139@qq.com
-- -- @创建时间:   2021-01-31 22:27:47
-- -- @最后修改来自: baidwwy
-- -- @Last Modified time: 2024-08-21 12:34:52
-- local sj = 取随机数
...
-- __GWdh111[136]=function(连接id,数字id,序列,标识,地图)
-- 	local 对话数据={}
-- 		对话数据.模型=任务数据[标识].模型
-- 		对话数据.名称=任务数据[标识].名称
...
-- __GWdh222[136]=function (连接id,数字id,序号,内容)
-- 	local 事件=内容[1]
-- 	local 名称=内容[3]
-- 	if 事件=="讨教一二" then
...
-- 		x待发送数据[地图]={}
-- 		for n=1,临时数量 do
-- 			local 任务id=地图.."_136_"..os.time().."_"..随机序列.."_"..取随机数(88,99999999).."_"..n
-- 			随机序列=随机序列+1
-- 			local 模型="烛龙"
-- 			local x称谓 = "烛龙之子"
-- 			任务数据[任务id]={
...
-- 	end
-- 	x待发送数据={}
-- 	广播消息({内容=format("#R/烛龙之子，鼓以在涿鹿复活"),频道="xt"})
-- end

-- function rwgx136(任务id)
