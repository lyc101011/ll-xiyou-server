...
-- @Last Modified time: 2025-04-12 20:59:05
-- @Author: baidwwy
...
function 自写活动:完成知了大王(id组)
    for n=1,#id组 do
        ...
        玩家数据[id].角色:添加储备(qz(银子*2*HDPZ["知了大王"].银子),"知了大王",1)
...
function 自写活动:完成知了统领(id组)
    for n=1,#id组 do
        ...
        玩家数据[id].角色:添加储备(qz(银子*2*HDPZ["知了统领"].银子),"知了统领",1)
...
function 自写活动:完成千年知了王(id组)
    for n=1,#id组 do
        ...
        玩家数据[id].角色:添加储备(qz(银子*2*HDPZ["千年知了王"].银子),"千年知了王",1)
...
function 自写活动:完成知了小王(id组)
    for n=1,#id组 do
        ...
        玩家数据[id].角色:添加储备(qz(银子*2*HDPZ["知了小王"].银子),"知了小王",1)
...
function 自写活动:完成裂风兽(id组)
    for n=1,#id组 do
        ...
        玩家数据[id].角色:添加储备(qz(银子*2*HDPZ["裂风兽"].银子),"裂风兽",1)
