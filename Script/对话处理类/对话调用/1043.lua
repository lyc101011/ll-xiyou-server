...
__NPCdh111[1043]=function (ID,编号,页数,已经在任务中,数字id)
	local wb = {}
	local xx = {}
	if 编号 == 1 then
		wb[1] = "我佛门心法只传授诚心向佛之士。"
		...
		return {"男人_老和尚","空度禅师",wb[sj(1,#wb)],xx,"门派师傅"}
	end
	return
end

__NPCdh222[1043 ]=function  (id,数字id,序号,内容)
	local 事件=内容[1]
  	local 名称=内容[3]
  	if 名称=="空度禅师" then
        local 门派类型="化生寺"
        ...
        elseif 事件=="文韵墨香" then
			...
			发送数据(id,3530,{道具=玩家数据[数字id].道具:索要道具1(数字id),名称="空度禅师",类型="NPC",等级="无"})
		elseif 事件=="我要做其他事情" then
		    添加最后对话(数字id,"我佛门心法只传授诚心向佛之士。",{"交谈","给予","乾元丹学习","师门任务","学习技能","我想切换流派"})
        end
    end
end