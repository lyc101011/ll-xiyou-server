...
function 战斗技能:靛沧海(战斗数据,编号,目标,目标数,执行数)
	local 等级 = 战斗数据:取技能等级(编号,"五行学说")*3 + 90 +战斗数据.参战单位[编号].固定伤害
	local 敏捷 = (战斗数据.参战单位[编号].敏捷)*0.7
	local 暗器 = 0
	if 战斗数据.参战单位[编号].暗器 ~=nil then --暗器技巧
		暗器 = 战斗数据.参战单位[编号].暗器
...
function 战斗技能:侵蚀·苍茫树·钻心(战斗数据,编号,目标,目标数,执行数)
	local 等级 = 战斗数据:取技能等级(编号,"五行学说")*3 + 130 +战斗数据.参战单位[编号].固定伤害
	local 敏捷 = (战斗数据.参战单位[编号].敏捷)*0.7
	local 暗器 = 0
	if 战斗数据.参战单位[编号].暗器 ~=nil then --暗器技巧
		暗器 = 战斗数据.参战单位[编号].暗器
...
function 战斗技能:侵蚀·苍茫树·刻骨(战斗数据,编号,目标,目标数,执行数)
	local 等级 = 战斗数据:取技能等级(编号,"五行学说")*3 + 150 +战斗数据.参战单位[编号].固定伤害
	local 敏捷 = (战斗数据.参战单位[编号].敏捷)*0.7
	local 暗器 = 0
	if 战斗数据.参战单位[编号].暗器 ~=nil then --暗器技巧
		暗器 = 战斗数据.参战单位[编号].暗器
