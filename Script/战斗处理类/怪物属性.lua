...
-- @Last Modified time: 2025-01-03 22:16:31
-- @Author: baidwwy
...
local 战斗单位={}
local sx
local 整体加强A = 1.8  --所有怪物增加60%气血
local 整体加强B = 1.2   --所有怪物增加10%伤害
local 整体加强C = 1.1   --所有怪物增加10%法伤
local 整体加强D = 1.1   --所有怪物增加10%速度
...
战斗单位[2]={
	...
	,模型="进阶炼丹童子"
		    ...
		    ,抵抗封印等级=等级+100
            ,修炼 = {物抗=xlz,法抗=xlz,攻修=xlz}
		    ,技能={"高级感知","高级幸运","高级精神集中","高级神佑复生","高级神迹","高级反震"}
		    ,门派=sx.门派
		    ,AI战斗 = {AI=sx.智能}
}
	local q门派 = qmenpai[i]
...
战斗单位[10]={
	...
	,模型="毗舍童子"
		    ...
		    ,抵抗封印等级=等级+100
            ,修炼 = {物抗=xlz,法抗=xlz,攻修=xlz}
		    ,技能={"高级感知","高级幸运","高级敏捷","高级神佑复生","高级神迹","高级夜战"}
		    ,门派=sx.门派
		    ,AI战斗 = {AI=sx.智能}
}
end
...
function 怪物属性:雁塔地宫信息(任务id,玩家id,序号)
	 ...
	 战斗单位[1]={
		...
		,速度 = qz( (sx.属性.速度 * 1.2+属性递增.速度) *gw[1].额外面板百分比.速度)
	...
	for n=2,#gw do
		...
		战斗单位[n]={
			...
			,速度 = qz( (sx.属性.速度 * 1.1+属性递增.速度) *gw[n].额外面板百分比.速度)
...
function 怪物属性:保卫长安_先锋(任务id,玩家id,序号)
	 ...
	 if 取随机数()<=50 then
		  ...
		  战斗单位[数量+1]={
				...
				,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[数量+1])
				,主动技能={"失心符","似玉生香","含情脉脉"}
		  }
	 end
	 return 战斗单位
...
function 怪物属性:取28星宿属性(任务id,玩家id,序号)
	 ...
	 for i=2,数量 do
		  ...
		  战斗单位[i]={
				...
				,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[1]*0.85)
				,主动技能=技能组
		  }
	 end
	 return 战斗单位
...
function 怪物属性:万年魔灵(任务id,玩家id,序号)
	 ...
	 战斗单位[1]={
		  ...
		  ,法伤 = qz(sx.属性.法伤 * QAQ[序号].法伤系数[1])
		  ,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[1])*2
		  ,固定伤害 = qz(等级*QAQ[序号].固伤系数[1])
		  ,治疗能力 = qz(等级*QAQ[序号].治疗系数[1])
		  ,技能={"高级吸血","高级必杀"}
		  ,门派=sx.门派
	 ...
	 战斗单位[6]={
		  ...
		  ,伤害 = qz(sx.属性.伤害 * QAQ[序号].伤害系数[6])
		  ,法伤 = qz(sx.属性.法伤 * QAQ[序号].法伤系数[6])
		  ,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[6])*2
		  ,固定伤害 = qz(等级*QAQ[序号].固伤系数[6])
		  ,治疗能力 = qz(等级*QAQ[序号].治疗系数[6])
		  ,技能={"高级神佑复生"}
		  ,门派="方寸山"
...
function 怪物属性:地煞星(任务id,玩家id,序号)
	 ...
	 战斗单位[1]={
		  ...
		  ,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[1]*难度系数)
		  ,固定伤害 = qz(等级*QAQ[序号].固伤系数[1])
		  ,治疗能力 = qz(等级*QAQ[序号].治疗系数[1])
	 ...
	 if 主怪是否为输出 then
		  ...
		  战斗单位[6]={
				...
				,伤害 = qz(sx.属性.伤害 * QAQ[序号].伤害系数[6])
				,法伤 = qz(sx.属性.法伤 * QAQ[序号].法伤系数[6])
				,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[6]*难度系数)
				,固定伤害 = qz(等级*QAQ[序号].固伤系数[6])
				,治疗能力 = qz(等级*QAQ[序号].治疗系数[6])
	 ...
	 for i=7,8 do
		  ...
		  战斗单位[i]={
				...
				,伤害 = qz(sx.属性.伤害 * QAQ[序号].伤害系数[i])
				,法伤 = qz(sx.属性.法伤 * QAQ[序号].法伤系数[i])
				,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[i]*难度系数)
				,固定伤害 = qz(等级*QAQ[序号].固伤系数[i])
				,治疗能力 = qz(等级*QAQ[序号].治疗系数[i])
				,修炼 = {物抗=xiulian,法抗=0,攻修=xiulian}
				,法伤减少=fashangjianshao
	 ...
	 战斗单位[10]={
		  ...
		  ,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[10])*1.5
		  ,固定伤害 = qz(等级*QAQ[序号].固伤系数[10])
		  ,修炼 = {物抗=xiulian,法抗=xiulian,攻修=xiulian}
...
function 怪物属性:六星地煞(任务id,玩家id,序号)
	 ...
	 if 主怪是否为输出 then
		  ...
		  战斗单位[6]={
				...
				,伤害 = qz(sx.属性.伤害 * QAQ[序号].伤害系数[6])
				,法伤 = qz(sx.属性.法伤 * QAQ[序号].法伤系数[6])
				,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[6]*难度系数)*1.2
				,防御 = qz(等级*12)+500
				,法防 = qz(等级*5)+800
				,固定伤害 = qz(等级*QAQ[序号].固伤系数[6])
				,治疗能力 = qz(等级*QAQ[序号].治疗系数[6])
	 ...
	 for i=7,8 do
		  ...
		  战斗单位[i]={
				...
				,伤害 = qz(sx.属性.伤害 * QAQ[序号].伤害系数[i])
				,法伤 = qz(sx.属性.法伤 * QAQ[序号].法伤系数[i])
				,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[i]*难度系数)*1.2
				,固定伤害 = qz(等级*QAQ[序号].固伤系数[i])
				,治疗能力 = qz(等级*QAQ[序号].治疗系数[i])
				,防御 = qz(等级*12)+800
				,法防 = qz(等级*5)+1000
	 ...
	 战斗单位[10]={
		  ...
		  ,伤害 = qz(sx.属性.伤害 * QAQ[序号].伤害系数[10])
		  ,法伤 = qz(sx.属性.法伤 * QAQ[序号].法伤系数[10])
		  ,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[10]*难度系数)*1.5
		  ,固定伤害 = qz(等级*QAQ[序号].固伤系数[10])
...
function 怪物属性:天罡星1到5星(任务id,玩家id,序号)
	 ...
	 战斗单位[1]={
		  ...
		  ,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[1])*牛逼C
...
function 怪物属性:自动抓鬼(任务id,玩家id,序号)
	...
	战斗单位[1]={
		...
		,速度 = qz(sx.属性.速度 * QAQ[100008].速度系数[1])
	...
	for i=2,数量 do
		...
		,速度 = qz(sx.属性.速度 * QAQ[100008].速度系数[i])
...
function 怪物属性:取门派闯关信息(任务id,玩家id,序号)
	 ...
	 for i=2,5 do
		  ...
		  战斗单位[i]={
				...
				,等级=等级
				,气血 = qz(sx.属性.气血 * QAQ[序号].气血系数[i])*1.5
				,伤害 = qz(sx.属性.伤害 * QAQ[序号].伤害系数[i])
				,法伤 = qz(sx.属性.法伤 * QAQ[序号].法伤系数[i])
				,速度 = qz(sx.属性.速度 * QAQ[序号].速度系数[i])
				,技能={"感知"}
