...
-- @Last Modified time: 2025-04-06 21:14:01
-- @Author: baidwwy
...
function 商店处理类:初始化()
	...
	self.商品列表={}
		...
		self.商品列表[54]={"高级魔兽要诀*200","召唤兽内丹*10",}  --购买矿产  采矿大师
	--21 23 为珍品商人
	...
	for i=1,18 do
	 ...
	 --云游道人
	self.商品列表[24]={"高级魔兽要诀*8000000","魔兽要诀*500000","随机怪物卡片*200000","召唤兽内丹*500000","高级召唤兽内丹*5000000"} --云游道人 --云游道人
	 --宝石商人
	 -------------------超级技能
		MRSPXZ={}
		...
		-------------------复制给初始化脚本里的商店列表
	self.商品列表[32]={"珍珠*2000000*160","钟灵石*3000000*5","翡翠石*1600000*5","舍利子*1600000*5","红玛瑙*1600000*5",
                          "黑宝石*1600000*5","光芒石*1600000*5","月亮石*1600000*5","太阳石*1600000*5","精魄灵石*3000000*5","玉葫灵髓*500000",
                          "如意丹*10000","易经丹*2000000","金鸦火羽（高级）*250000","精致碎石锤*1000000*1","福禄丹*3000000","天赋符*2000000",
                          "神兽涎*" ..MRSPXZ["神兽涎"].价格 ,"仙露小丸子*" ..MRSPXZ["仙露小丸子"].价格,"清灵净瓶*500000" }
end
